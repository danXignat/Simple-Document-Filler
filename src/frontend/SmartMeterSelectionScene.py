...
class SmartMeterSelectionScene(Scene):
    ...
    def model_chosen(self, choice):
        ...
        self.local_entries["Eficienta"].set(smart_meter_data["Eficiență"])
        self.local_entries["Interval temperatura"].set(smart_meter_data["Interval Funcționare"])
        self.local_entries["Garantie"].set(smart_meter_data["Garanție"])
        self.local_entries["Grad protectie"].set(smart_meter_data["Grad Protecție"])
        self.local_entries["Frecventa"].set(smart_meter_data["Frecvență"])
        self.local_entries["Umiditate"].set(smart_meter_data["Umiditate Maximă"])
